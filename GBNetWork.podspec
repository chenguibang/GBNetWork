#
#  Be sure to run `pod spec lint GBNetWork.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
GBNetWork. for quik development GBNetWork. for quik development
                   DESC

  s.homepage     = "https://github.com/chenguibang/GBNetWork.git"
  ...
  s.source       = { :git => "https://github.com/chenguibang/GBNetWork.git", :tag => "#{s.version}" }
  ...
  s.source_files  = "GBNetWork", "GBNetWork/**/*.{h,m}"
